					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								...
								<a href="{{ route('featured-post.index') }}"><i class="fa fa-quote-left"></i> <span>Featured Post</span></a>
								{{-- @endif --}}
								{{-- @if (in_array('Expertise',json_decode(Auth::guard('admin')->user()->role->permission))) --}}
								<a href="{{ route('menu.index') }}"><i class="fa fa-star"></i> <span>Menu</span></a>
								{{-- @endif --}}
								{{-- @if (in_array('Vision',json_decode(Auth::guard('admin')->user()->role->permission))) --}}
								<a href="{{ route('gallery.index') }}"><i class="fa fa-eye"></i> <span>Gallery</span></a>
								{{-- @endif
                            ...
                            <li> 
								<a href="{{ route('setting.index') }}"><i class="fa fa-cog"></i> <span>Setting</span></a>
							</li>
						</ul>
					</div>
                </div>
